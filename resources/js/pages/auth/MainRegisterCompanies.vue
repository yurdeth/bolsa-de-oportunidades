        ...
        <form class="login-card" @submit.prevent="register" v-if="!loading">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            <input
                                ...
                                name="nombre"
                                placeholder="Ingrese el nombre comercial de su empresa"
                                v-model="form.nombre"
                                style="height: 40px"
                                required
                                autofocus
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            <input
                                ...
                                name="direccion"
                                placeholder="Ingrese la ubicación de su empresa"
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            <input
                                ...
                                type="text"
                                class="form-control"
                                :class="{ 'is-invalid': errors.sitio_web }"
                                name="sitio_web"
                                placeholder="Ingrese el sitio web de su empresa"
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            <select
                                id="id_sector"
                                class="form-control"
                                :class="{ 'is-invalid': errors.id_sector }"
                                name="id_sector"
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            <textarea
                                ...
                                name="descripcion"
                                placeholder="Ingrese una descripción de su empresa"
                                style="height: 40px"
            ...
            <div class="text-center mt-3">
                <p>
                    ...
                    <a href="/login" class="text-danger">Iniciar Sesión</a>
                </p>
            </div>
        </form>
    </div>
